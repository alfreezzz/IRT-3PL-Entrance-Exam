...
@section('content')
    <div class="w-full max-w-md mx-auto space-y-6">
        ...
        <div class="text-center space-y-2">
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400">Masukkan kredensial Anda untuk melanjutkan</p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    <label class="inline-flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 cursor-pointer select-none">
