            ...
            <nav class="space-y-1">
                @auth
                    @if (auth()->user()->role === 'admin')
                        ...
                        <x-sidebar.sidebar-link href="{{ route('subtests.index') }}" label="Subtes" :active="request()->routeIs('subtests.*')">
                            <x-slot:icon>
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <x-sidebar.sidebar-link href="{{ route('exams.index') }}" label="Ujian" :active="request()->routeIs('exams.*')">
                            <x-slot:icon>
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
